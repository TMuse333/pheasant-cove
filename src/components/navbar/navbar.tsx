...
const Navbar: React.FC<NavbarProps> = ({ links }) => {
    ...
    return (
        <nav className="fixed top-0 z-20 w-screen left-0 bg-gradient-to-b from-blue-900 to-blue-700 h-[100px] flex justify-between items-center">
            <div className="relative flex justify-between items-center w-screen    lg:justify-around">
                <Link to='/' >
    ...
    Pheasant Cove
                ...
                >
                    ...
                    <ul
                        className={`text-left bg-radial-gradient from-blue-500 to-blue-900 fixed right-[5%] top-[70px] overflow-hidden transition-[height] flex flex-col items-center justify-center rounded-lg w-[140px] lg:bg-transparent lg:w-auto lg:relative lg:overflow-auto lg:top-auto lg:right-auto lg:flex-row ${subMenuClicked ? 'h-[120px] bg-radial-gradient from-blue-500 to-blue-900 p-0' : 'h-[0px] p-0 lg:h-auto'}`}
                    >
