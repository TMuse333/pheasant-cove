                    ...
                    <ul
                        className={` text-left fixed right-[5%] top-[70px]
                         overflow-hidden transition-[height] flex flex-col items-center
                          justify-center rounded-lg w-[140px]  lg:w-screen
                         lg:relative lg:overflow-auto lg:top-auto lg:right-auto
                          lg:flex-row  justify-around ${subMenuClicked ? 'h-[300px] bg-radial-gradient from-blue-500 to-blue-900 p-0' : 'h-[0px] p-0 lg:h-auto'}`}
                    >
