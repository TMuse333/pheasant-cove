        ...
        <nav className="fixed top-0 z-[200] w-screen left-0 bg-gradient-to-b from-blue-900 to-blue-800 h-[50px] flex justify-between items-center text-white">
            <div className="relative flex justify-between items-center w-screen ml-auto mr-auto">
                ...
                >
                    ...
                    <ul
                        className={`text-left fixed right-[5%] top-[70px] overflow-hidden transition-[height] flex flex-col items-center justify-center rounded-lg w-[140px] sm:w-screen sm:relative sm:overflow-auto sm:top-auto sm:right-auto sm:flex-row justify-around sm:text-center ${subMenuClicked ? 'h-[100px] bg-radial-gradient from-blue-500 to-blue-900 p-0' : 'h-[0px] p-0 sm:h-auto'}`}
                    >
