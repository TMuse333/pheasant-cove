    ...
    >
      ...
      {customText ? (
        ...
        <div className={`md:w-[40vw] ${!reverse ? 'md:mr-8' : ''}`} >
          ...
          initial={hasAnimation ? 'initial' : ''}
          animate={hasAnimation && inView ? 'animate' : ''}
           className="text-left pl-5 sm:pl-12 pt-5">{mainTitle}
           Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quaerat magni deleniti repudiandae eius ab corporis assumenda ea fugit temporibus, necessitatibus aspernatur alias velit explicabo accusamus earum reprehenderit perferendis culpa iure.</motion.h1>
          <motion.p
