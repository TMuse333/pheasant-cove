...
const Navbar: React.FC<NavbarProps> = ({ links }) => {
    ...
    return (
        <nav className="fixed top-0 z-20 w-screen left-0 bg-blue-900 h-[100px] flex justify-between items-center">
            <div className="relative flex justify-between items-center w-screen lg:w-[80vw] max-w-[767px] lg:justify-evenly lg:items-stretch">
                ...
                <p className="ml-2 lg:text-2xl mr-auto lg:mr-0 pl-6 lg:pl-0">Pheasant Cove</p>
                </Link>
                <div
                    ...
                    >
                        {links.map((link, index) => (
                            <Link key={index} to={link.destination}>
                                <li className="text-md lg:text-2lg mb-2
                                 pl-2 pr-2 lg:mb-0
