...
const Carousel: React.FC<CarouselProps> = ({ images, hasDescription }) => {
    ...
    <div
        className={`
            ...
            ${!carouselClicked ? `w-[90vw] h-[80vw] max-h-[400px] md:max-h-[520px]` : 'w-[100vw] h-[100vw]'}
    ...
    >
        <img
            src={image.url}
            className={`
                ${!carouselClicked ? `w-[80%] max-w-[405px] max-h-[424px] h-[100%]` : `w-[100vw] max-w-[1400px] max-h-[1500px] h-[100%]`}
                object-cover ${image.imageIndex === 5 ? 'object-top' : 'object-bottom'} ml-auto mr-auto`}
        />
    </div>
