...
`}>
        ...
        <div className='w-[80vw]  sm:w-[60vw] h-[75vw]
   sm:h-[40vw] max-h-[380px]
   max-w-[450px]
   md:max-h-[520px] max-h-[390px]
   md:max-h-[520px] absolute flex justify-between items-center'>

<button className='bg-white p-0 left-0
...
'>
        ...
        <button className=' bg-white p-0  right-0'>
            <ChevronRight
            size={40}
