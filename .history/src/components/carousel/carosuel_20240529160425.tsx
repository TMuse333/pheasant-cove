...
items-center h-[100%] bg-green-200
...
${!carouselClicked ? `max-h-[424px]

max-w-[400px]` : `  max-w-[1800px]
max-h-[1200px]`}
...
{/* <button className='bg-white p-0 absolute left-0
'>
        <ChevronLeft
        ...
        <button className=' bg-white p-0 absolute right-0'>
            <ChevronRight
            size={40}
            onClick={handleNextClick}/>
        </button> */}

        <div className='w-[90vw] absolute top-0 sm:w-[70vw] h-[80vw]
   sm:h-[50vw] max-h-[390px]
   md:max-h-[520px] max-h-[390px]
   md:max-h-[424px] absolute border border-pink-200
   max-w-[400px]'>
